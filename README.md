...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/royal-moon-5764
```

A live public deployment of this template is available at [https://royal-moon-5764.templates.workers.dev](https://royal-moon-5764.templates.workers.dev)
